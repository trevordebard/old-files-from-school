...
public class Fraction
{
    ...
    public Fraction add(Fraction f) 
    {
        ...
        if (sumFract.bottom < 0)
        {
         ...
         int common = gCD(sumFract.top, sumFract.bottom);
         sumFract.top /= common;
         sumFract.bottom /= common;
    ...
    public Fraction subtract(Fraction f) 
    {
        ...
        if (subFract.bottom < 0)
        {
         ...
         int common = gCD(subFract.top, subFract.bottom);
         subFract.top /= common;
         subFract.bottom /= common;
    ...
    public Fraction multiply(Fraction f) 
    {
        ...
        if (multFract.bottom < 0)
        {
         ...
         int common = gCD(multFract.top, multFract.bottom);
         multFract.top /= common;
         multFract.bottom /= common;
    ...
    public Fraction divide(Fraction f) 
    {
        ...
        int greatest = gCD(topQuot, bottomQuot);
        return new Fraction(topQuot/greatest, bottomQuot/greatest);
    }
